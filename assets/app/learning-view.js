...
(function (global) {
  ...
  app.createLearningView = function createLearningView(options) {
    ...
    function makeButton(node) {
      const domain = domains[node.domain] || { color: "#888", label: node.domain };
    ...
    function updateCounts() {
      ...
      elements["learning-total-count"].textContent = ` / ${total} 个节点`;
    ...
    return Object.freeze({ bindButtons, init, preloadNeighbors, renderButtonHtml });
  };
})(window);
