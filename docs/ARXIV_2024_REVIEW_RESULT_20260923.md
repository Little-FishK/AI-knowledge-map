# 2024 年 arXiv 内容审核：本轮结果

按首次提交时间 2024-01-01 至 2024-12-31、与 2025/2026 年相同的三路候选规则和重要性门槛，本轮共登记 **107,619 篇候选**。其中 **2 篇完成六步审核并达到收录要求**。
...
|---|---:|---|
| 可以收录 | 2 | 六步均通过 |
| 暂缓 | 107,491 | 本轮没有命中可采信的必要评价证据；保留候选 |
| 待补证 | 126 | 存在评价线索，但机制、身份或重大贡献依据未齐 |
| 合计 | 107,619 | 每个 arXiv ID 恰有一个处置 |
...
完整 arXiv 快照中共有 242,671 篇在 2024 年首次提交。对全部记录应用八个 AI 相关分类、130 个标题/摘要布尔检索式，再合并正式评价线索，得到去重候选池。
...
审核深度分别为：六步审核 2 篇，逐篇证据检查 7 篇，官方名单与元数据匹配 2 篇，必要证据自动查表 107,608 篇。后者没有被写成已经精读摘要或全文。
