...
function writeArtifact({root, output, entries, inventory, siteUrl, mode, graph, publicationPolicy = 'approved-only'}) {
  ...
  for (const name of ['data/graph.js','data/locales','data/content-locales/en/graph.js','data/software.js','data/library.js','data/library-official-technical.js','data/library-official-openai-importance-01.js','data/library-official-openai-importance-02.js','data/library-official-openai-importance-03.js','data/library-official-openai-importance-04.js','data/library-official-openai-importance-05.js','data/library-official-anthropic-importance-01.js','data/library-official-anthropic-importance-02.js','data/library-official-anthropic-importance-03.js','data/library-official-anthropic-importance-04.js','data/library-official-google-deepmind-importance-01.js','data/library-official-google-deepmind-importance-02.js','data/library-official-microsoft-importance-01.js','data/library-official-microsoft-importance-02.js','data/library-official-microsoft-importance-03.js','data/library-official-microsoft-importance-04.js','data/library-official-microsoft-importance-05.js','data/library-official-microsoft-importance-06.js','data/library-official-microsoft-importance-07.js','data/library-official-china.js','data/library-platform-profiles.js','data/library-source-meta.js','data/library-new-sources.js','data/library-hackathon-kaggle.js','data/library-arxiv.js','data/library-neurips-proceedings.js','data/library-pmlr.js','data/library-openreview.js','data/library-acl-anthology.js','data/library-cvf-open-access.js','data/library-ieee-xplore.js','data/library-acm-digital-library.js','data/tutorials.js','data/tutorials-codex-youtube.js','data/tutorials-claude-code.js','data/tutorials-video-generated.js']) copyTree(name, p => /\.(?:js|json)$/.test(p));
  ...
  const conceptHref = id => publishedChinese.has(id) ? base + route(id, 'zh') : `${base}?lang=zh-Hans#/map/${encodeURIComponent(id)}`;
  ...
  const seoPages=[
    seo.metadata({siteUrl,path:'',title:positioning.homeTitle,description:positioning.homeDescription}),
  ...
  for(const meta of seoPages){
    ...
    if (file !== 'index.html' && !directoryMetadata.includes(meta)) html = require('./reading-shell').apply(html, home, base, graph.meta);
    if (directoryMetadata.includes(meta) && meta.locale === 'en') html = html.replace('跳到正文 / Skip to content','Skip to content').replace('>AI 知识地图</a>','>AI Knowledge Map</a>').replace('>搜索与文字目录 / Search</a>','>Search concepts</a>');
