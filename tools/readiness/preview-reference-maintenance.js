...
server.stdout.on('data',chunk=>{
  ...
  while((end=buffer.indexOf('\n'))>=0){
    ...
    if(message.id===1){
      ...
      send(2,'tools/call',{name:'stage2_diagnose_candidate_gate',arguments:{pageId:'neural-network',referenceUpdatePreview:true}});
    }
...
send(1,'initialize',{protocolVersion:'2024-11-05',capabilities:{},clientInfo:{name:'reference-maintenance-preview',version:'1.0'}});
