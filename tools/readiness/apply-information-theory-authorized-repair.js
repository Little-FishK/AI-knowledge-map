...
server.stdout.on('data',chunk=>{
  ...
  while((end=buffer.indexOf('\n'))>=0){
    ...
    if(message.id===1){
      ...
      send(2,'tools/call',{name:'stage2_apply_information_theory_authorized_repair',arguments:{expectedCandidateHash:'sha256:91c155d089a7fe2654b371317ee48b2bb384bf24dce4511c89c854ba470207ee'}});
    }
...
send(1,'initialize',{protocolVersion:'2024-11-05',capabilities:{},clientInfo:{name:'information-theory-authorized-repair',version:'1.0'}});
