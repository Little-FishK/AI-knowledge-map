...
<header class="preview-header"><a class="preview-brand" href="${base}?lang=${lang}#/map">◈ ${english ? "AI Knowledge Map" : "AI 知识地图"}</a>
...
<main id="main-content" tabindex="-1"><article id="dd-article">
...
<!-- source-body:start -->${english ? resourceLayout(page.html, { splitLegend: pageId === "supervised-learning" }) : page.html}<!-- source-body:end -->
