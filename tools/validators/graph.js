...
const { PROJECT_ROOT, resolveProjectRoot } = require("../shared/project-root");
const layoutQuality = require(path.join(PROJECT_ROOT, "assets", "layout-quality.js"));
const graphRoot = resolveProjectRoot("GRAPH_ROOT");
