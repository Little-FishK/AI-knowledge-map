...
function createPublication(options) {
  ...
  function publishedTargets(root, record, page, audit) {
    ...
    if (record.integration) {
      ...
      targets.push(targetRecord(root, `data/deepdive/zzzzz-stage2-${id}.js`, pageOverrideSource(id, page)));
    }
  ...
  function provisionalPublishedTargets(root, record, page, audit) {
    ...
    const targets = [
      targetRecord(root, `data/deepdive/zzzzz-stage2-${record.id}.js`, pageOverrideSource(record.id, page)),
