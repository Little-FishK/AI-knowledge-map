...
- 提案 / 独立复核：`reject` / `reject`
- 全图去重：existing；最相近：mcp(1)、mcp-architecture(1)、agent-identity-access(0.018)、test-time-compute(0.0147)、agent-frameworks(0.0132)
- 视频证据：1/1 有效
- 外部来源 / 断言：0 / 0
- 关系 / 学习路径：未通过 / 未通过
- 影子结论：新节点 不合格；核心 不合格
...
- 提案 / 独立复核：`reject` / `reject`
- 全图去重：existing；最相近：agent-skills(1)、mcp(0.0155)、clip(0.0131)、post-training(0.0124)、tool-calling(0.0118)
- 视频证据：1/1 有效
- 外部来源 / 断言：0 / 0
- 关系 / 学习路径：未通过 / 未通过
- 影子结论：新节点 不合格；核心 不合格
