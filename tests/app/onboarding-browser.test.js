...
async function main() {
  ...
  try {
    ...
    const relationship=()=>page.evaluate(()=>({selected:__cy.nodes('.sel').map(n=>n.id()),nodes:__cy.nodes().map(n=>({id:n.id(),position:n.position(),classes:n.classes()})),hash:location.hash,zoom:__cy.zoom()}));
