...
const batchId = "meta-ai-value-score-batch-05";
...
assert.deepStrictEqual(score.summary, { reviewed:60, retained:15, removed:45 });
...
for (const relative of ["data/library.js", "data/library-official-technical.js", "data/library-official-meta-ai-importance-01.js", "data/library-official-meta-ai-importance-02.js", "data/library-official-meta-ai-importance-03.js", "data/library-official-meta-ai-importance-04.js", "data/library-official-meta-ai-importance-05.js"]) {
...
assert.strictEqual(items.length, 116);
assert.strictEqual(new Set(items.map(item => item.id)).size, 116);
console.log("✓ Meta AI 第五批 60 份价值评分通过（保留 15，移除 45；累计保留 116）");
