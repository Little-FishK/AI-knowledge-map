...
const score = JSON.parse(fs.readFileSync(path.join(root, "proposals", "official-technical", "microsoft-value-score-batch-01.json"), "utf8"));
...
const batchInventoryRecords = inventory.records.filter(record => record.scoreBatch === "microsoft-value-score-batch-01");
...
for (const relative of ["data/library.js", "data/library-official-technical.js", "data/library-official-microsoft-importance-01.js"]) {
