...
(function () {
  ...
  const groups = [
    ...
    },
    {
      ...
      rows: [
        ["bfcl-v2-live", "BFCL V2：Live and Irrelevance Detection", "函数调用基准重要版本", "https://gorilla.cs.berkeley.edu/blogs/12_bfcl_v2_live.html", "加入实时函数、无关函数识别和数据污染缓解设计。", "支持解释 BFCL 从静态函数调用到实时评测的扩展。", ["函数调用", "实时评测"], ["tool-calling", "model-evaluation"]],
        ["bfcl-v3-multiturn", "BFCL V3：Multi-Turn and Multi-Step", "多轮工具调用基准", "https://gorilla.cs.berkeley.edu/blogs/13_bfcl_v3_multi_turn.html", "增加多轮、多步骤和状态依赖的工具调用任务。", "支持评估智能体在连续交互中的工具规划和执行。", ["工具调用", "多轮Agent"], ["agent", "tool-calling"]],
        ["bfcl-v4-memory", "BFCL V4：Memory Evaluation", "智能体记忆评测", "https://gorilla.cs.berkeley.edu/blogs/16_bfcl_v4_memory.html", "评估跨轮次检索、更新和利用信息的智能体记忆能力。", "支持解释 BFCL V4 记忆任务和评分。", ["Agent记忆", "工具调用"], ["agent", "tool-calling"]],
        ["bfcl-v4-format-sensitivity", "BFCL V4：Prompt and Format Sensitivity", "格式鲁棒性评测", "https://gorilla.cs.berkeley.edu/blogs/17_bfcl_v4_prompt_variation.html", "测量工具定义、提示和输出格式变化对函数调用表现的影响。", "支持判断工具调用能力对格式的鲁棒性。", ["格式鲁棒性", "工具调用"], ["tool-calling", "model-evaluation"]]
      ]
    }
  ];
