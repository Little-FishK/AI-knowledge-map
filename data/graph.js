...
window.GRAPH = {
  ...
  positions: {
    "attention": [7, -109],
    "transformer": [232, 6],
    "residual-connection": [406, -225],
    "vanishing-gradient": [220, -129],
    "scaling-law": [104, -196],
    "llm": [-78, -68],
    "tokenization": [-160, -256],
    "embedding": [98, 250],
    "context-window": [-267, 46],
    "lost-in-middle": [28, 146],
    "sampling-params": [-201, -30],
    "fine-tuning": [-60, 255],
    "neural-network": [398, 85],
    "gradient-descent": [312, -106],
    "backprop": [316, -336],
    "overfitting": [-59, 516],
    "cnn": [605, -40],
    "rnn": [462, -126],
    "supervised-learning": [135, 403],
    "unsupervised-learning": [248, 216],
    "reinforcement-learning": [-501, -18],
    "decision-tree": [410, 318],
    "clustering": [220, 474],
    "dimensionality-reduction": [310, 440],
    "pretraining": [92, 29],
    "rag": [-174, 132],
    "vector-db": [-194, 381],
    "prompt-engineering": [-346, 25],
    "chunking": [-309, 336],
    "retrieval": [-37, 396],
    "structured-output": [-605, -18],
    "cot": [-212, 261],
    "agent": [-329, -86],
    "tool-calling": [-522, -268],
    "mcp": [-536, -516],
    "agent-loop": [-340, -236],
    "agent-memory": [-460, 118],
    "diffusion": [472, 185],
    "image-generation": [286, 334],
    "hallucination": [-413, 223],
    "prompt-injection": [-251, -332],
    "jailbreak": [-244, -141],
    "alignment": [-295, 129],
    "reasoning-models": [-34, 65],
    "agent-frameworks": [-377, -349]
  },
