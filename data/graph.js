...
window.GRAPH = {
  ...
  positions: {
    "attention": [18, -156],
    "transformer": [196, -81],
    "residual-connection": [403, -299],
    "vanishing-gradient": [230, -214],
    "scaling-law": [82, -260],
    "llm": [-19, -40],
    "tokenization": [-25, -292],
    "embedding": [251, 159],
    "context-window": [-164, 37],
    "lost-in-middle": [68, 61],
    "sampling-params": [-267, -64],
    "fine-tuning": [-20, 295],
    "neural-network": [403, -40],
    "gradient-descent": [301, -307],
    "backprop": [441, -431],
    "overfitting": [137, 503],
    "cnn": [605, -98],
    "rnn": [474, -208],
    "supervised-learning": [209, 276],
    "unsupervised-learning": [384, 164],
    "reinforcement-learning": [-200, 158],
    "decision-tree": [505, 193],
    "clustering": [369, 399],
    "dimensionality-reduction": [279, 390],
    "pretraining": [301, -90],
    "rag": [-99, 179],
    "vector-db": [84, 200],
    "prompt-engineering": [-248, 62],
    "chunking": [-89, 411],
    "retrieval": [92, 348],
    "reranking": [193, 46],
    "constrained-decoding": [-415, -263],
    "prompt-caching": [-201, -205],
    "structured-output": [-523, -42],
    "cot": [-432, 60],
    "agent": [-348, 17],
    "tool-calling": [-537, -263],
    "mcp": [-605, -503],
    "mcp-architecture": [-368, -454],
    "agent-loop": [-393, -138],
    "agent-memory": [-260, 277],
    "diffusion": [378, 64],
    "image-generation": [453, 302],
    "hallucination": [-392, 260],
    "prompt-injection": [-288, -232],
    "jailbreak": [-89, -192],
    "reward-hacking": [-169, 348],
    "alignment": [-10, 103],
    "reasoning-models": [-175, -101],
    "agent-frameworks": [-301, 176]
  },
