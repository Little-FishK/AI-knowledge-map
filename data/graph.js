...
window.GRAPH = {
  ...
  positions: {
    "attention": [59, -67],
    "transformer": [141, 102],
    "residual-connection": [334, 147],
    "vanishing-gradient": [348, -70],
    "scaling-law": [48, 346],
    "llm": [-37, 110],
    "tokenization": [-209, 112],
    "embedding": [53, -197],
    "context-window": [-180, -89],
    "lost-in-middle": [-3, -314],
    "sampling-params": [-312, 164],
    "fine-tuning": [-62, -25],
    "neural-network": [434, 71],
    "gradient-descent": [459, 316],
    "backprop": [546, 84],
    "overfitting": [-53, -211],
    "cnn": [576, 214],
    "rnn": [353, 239],
    "supervised-learning": [163, -140],
    "unsupervised-learning": [243, 39],
    "reinforcement-learning": [-315, 322],
    "decision-tree": [445, -166],
    "clustering": [269, -149],
    "dimensionality-reduction": [234, -243],
    "pretraining": [221, 277],
    "rag": [-159, -235],
    "vector-db": [33, -464],
    "prompt-engineering": [-265, -39],
    "chunking": [-360, -319],
    "retrieval": [-152, -435],
    "reranking": [132, -312],
    "constrained-decoding": [-576, 216],
    "prompt-caching": [-123, 173],
    "structured-output": [-546, -21],
    "cot": [-421, 81],
    "agent": [-294, 45],
    "tool-calling": [-464, 215],
    "mcp": [-467, 464],
    "agent-loop": [-438, -47],
    "agent-memory": [-364, -155],
    "diffusion": [341, 20],
    "image-generation": [320, -258],
    "hallucination": [-460, -175],
    "prompt-injection": [-236, 243],
    "jailbreak": [-78, 447],
    "alignment": [-58, 275],
    "reasoning-models": [-174, 340],
    "agent-frameworks": [-522, 80]
  },
