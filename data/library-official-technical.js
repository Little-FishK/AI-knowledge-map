...
(function () {
  ...
  addGroup({
    ...
    ["microsoft-content-filtering", "Content filtering for Microsoft Foundry Models (classic)", "https://learn.microsoft.com/en-us/azure/foundry-classic/foundry-models/concepts/content-filter?view=foundry-classic",
      "解释经典版 Microsoft Foundry 模型的输入输出分类器、风险等级、阻断阈值和可配置过滤器。",
  ...
  addGroup({
    ...
    ["meta-llama-models", "Llama models", "https://github.com/meta-llama/llama-models",
    ...
    ["meta-dinov2", "DINOv2", "https://github.com/facebookresearch/dinov2",
