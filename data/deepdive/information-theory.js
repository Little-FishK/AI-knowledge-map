    ...
    "sectionContracts": [
      {
        "section": 1,
        "definition": {
          "answer": "定义事件集合、P 与 Q、对数和按 P 取期望。",
          "evidence": "P(x) 表示事件 x 真实出现的概率"
        },
        "problem": {
          "answer": "解决后续公式对什么对象计算、怎样区分 P 与 Q。",
          "evidence": "后面所有公式究竟在对什么对象做计算"
        },
        "inputOutput": {
          "answer": "输入是事件集合和分布，输出是概率值和加权期望。",
          "evidence": "按 P 取期望"
        },
        "mechanism": {
          "answer": "计算先确认事件由 P 产生，按 Q 求损失后用 P 平均。",
          "evidence": "后续所有计算都遵循一个规则"
        },
        "interpretation": {
          "answer": "教学例子直接给 P，现实 P 通常未知。",
          "evidence": "现实中 P 通常未知"
        },
        "boundary": {
          "answer": "样本有偏差，频率不等于真实概率。",
          "evidence": "样本可能有偏差"
        }
      },
      {
        ...
        "inputOutput": {
          "answer": "输入事件及真实概率，输出 bit 表示的自信息。",
          "evidence": "bit 表示的自信息"
        },
        "mechanism": {
          "answer": "取概率以 2 为底对数再加负号。",
          "evidence": "log<sub>2</sub>"
        },
        "interpretation": {
          "answer": "数值越大该结果越罕见。",
          "evidence": "越罕见"
        ...
        "boundary": {
          "answer": "高自信息不等于事件重要或正确。",
          "evidence": "高自信息不等于事件重要"
        }
      },
      {
        "section": 3,
        "definition": {
          "answer": "熵是把自信息按真实频率求加权平均。",
          "evidence": "把每个事件的自信息按真实频率 P 求平均"
        },
        "problem": {
          "answer": "把单次意外程度汇总成分布级指标。",
          "evidence": "怎样概括一个分布整体上有多难预测"
        },
        "inputOutput": {
          "answer": "输入完整分布 P，输出 bit/次 的平均不确定性。",
          "evidence": "bit/次"
        },
        "mechanism": {
          "answer": "先求各事件自信息，再按 P(x) 加权相加。",
          "evidence": "加权相加"
        },
        "interpretation": {
          "answer": "熵更高表示长期更难预测。",
        ...
        "boundary": {
          "answer": "衡量不确定性非正确性，依赖分布稳定前提。",
          "evidence": "编码解释依赖长期、无损和分布稳定"
        }
      },
      {
        "section": 4,
        "definition": {
          "answer": "交叉熵是数据按 P 出现而由 Q 预测时的平均对数损失。",
          "evidence": "平均对数损失"
        },
        "problem": {
          "answer": "衡量模型 Q 预测真实 P 时平均要付出多少代价。",
          "evidence": "真实事件按 P 出现，模型却按 Q 分配概率"
        },
        "inputOutput": {
          "answer": "输入 P 和 Q，输出 bit/事件 的交叉熵。",
          "evidence": "H(P,Q)"
        },
        "mechanism": {
          "answer": "P 决定频率，Q 决定每个事件的损失，P 加权平均。",
          "evidence": "P 决定哪些事件多常出现"
        },
        "interpretation": {
          "answer": "数值较低表示 Q 给真实事件更高概率。",
          "evidence": "数值较低表示 Q 平均给真实事件分配了更高概率"
        },
        "boundary": {
          "answer": "不同数据分布或单位下不能直接横向比较。",
          "evidence": "不同数据分布、对数底数或预测单位下的数值不能直接横向比较"
        }
      },
      {
        "section": 5,
        "definition": {
          "answer": "KL 散度衡量使用 Q 代替 P 后每次平均多付出的 bit 数。",
          "evidence": "每次事件平均多付出的 bit 数"
        },
        "problem": {
          "answer": "分离模型概率放错位置造成的额外损失。",
          "evidence": "模型概率放错位置造成的额外损失"
        },
        "inputOutput": {
          "answer": "输入有方向的 P 与 Q，输出 KL 散度。",
          "evidence": "D<sub>KL</sub>"
        },
        "mechanism": {
          "answer": "先求交叉熵再减去 P 自身的熵。",
          "evidence": "H(P,Q) 减去 H(P)"
        },
        "interpretation": {
          "answer": "为零表示完全匹配，越大代价越高。",
          "evidence": "Q 在 P 会发生的事件上完全匹配"
        },
        "boundary": {
          "answer": "方向不可交换，P 未知只能估计。",
          "evidence": "方向不可交换"
        }
      },
      {
        "section": 6,
        "definition": {
          "answer": "比较几何坐标差与概率编码代价两类问题。",
          "evidence": "几何坐标差与概率编码代价是两种不同问题"
        },
        "problem": {
          "answer": "防止把有方向的 KL 误当普通距离。",
          "evidence": "防止把 KL 当作普通距离"
        },
        "inputOutput": {
          "answer": "输入概率向量，输出几何长度和对数代价。",
          "evidence": "欧氏距离输出对称的几何长度"
        },
        "mechanism": {
          "answer": "欧氏距离开方，KL 按 P 加权对数比。",
          "evidence": "逐坐标求差、平方并求和，再开方"
        },
        "interpretation": {
          "answer": "数值小都可表示接近但含义不同。",
          "evidence": "单位和含义不同"
        },
        "boundary": {
          "answer": "两个数不能互换相加。",
